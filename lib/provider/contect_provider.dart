...
class ContactProvider extends ChangeNotifier {
  List<Contact> contactList = [
    ...
    Contact(name: "Kunal Mehta", number: "5550000007", email: "kunal@example.com", address: "909 Main St"),
    Contact(name: "Aarti Chawla", number: "5550000008", email: "aarti@example.com", address: "1010 Main St"),
    Contact(name: "Nikhil Joshi", number: "5550000009", email: "nikhil@example.com", address: "1111 Main St"),
    Contact(name: "Shreya Bose", number: "5550000010", email: "shreya@example.com", address: "1212 Main St"),
    Contact(name: "Kiran Khanna", number: "5550000011", email: "kiran@example.com", address: "1313 Main St"),
    Contact(name: "Rajesh Malhotra", number: "5550000012", email: "rajesh@example.com", address: "1414 Main St"),
    Contact(name: "Meera Aggarwal", number: "5550000013", email: "meera@example.com", address: "1515 Main St"),
    Contact(name: "Abhishek Pandey", number: "5550000014", email: "abhishek@example.com", address: "1616 Main St"),
    Contact(name: "Sonal Bhatia", number: "5550000015", email: "sonal@example.com", address: "1717 Main St"),
    Contact(name: "Ravi Kulkarni", number: "5550000016", email: "ravi@example.com", address: "1818 Main St"),
  ];
